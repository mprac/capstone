...
<button type="button" className="btn btn-outline-primary btn-md" onClick={props.Delete}><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
