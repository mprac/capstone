...
const RejectButton = (props) => {
    ...
    return (
        <>
            <button className="btn btn-outline-primary" onClick={props.handleReject}><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-person-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
