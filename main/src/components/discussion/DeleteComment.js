...
class DeleteComment extends Component {
    ...
    render() {
        return (
            <>
                <small onClick={this.props.deleteComment}><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-trash text-danger" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
